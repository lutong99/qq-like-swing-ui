...
public class MoveBoxCenterPanel extends JPanel {
	...
	JLabel levelJLabel;
	// 引入图片
	private Image imgs[] = { new ImageIcon("resources/GameImages/.gif").getImage(), // 0
			new ImageIcon("resources/GameImages/1.gif").getImage(), // 1
			new ImageIcon("resources/GameImages/2.jpg").getImage(), // 2
			new ImageIcon("resources/GameImages/9.jpg").getImage(), // 3
			new ImageIcon("resources/GameImages/4a.GIF").getImage(), // 4
			new ImageIcon("resources/GameImages/5.gif").getImage(), // 5
			new ImageIcon("resources/GameImages/6.gif").getImage(), // 6
			new ImageIcon("resources/GameImages/7.gif").getImage(), // 7
			new ImageIcon("resources/GameImages/8.gif").getImage(), // 8
			new ImageIcon("resources/GameImages/9a.GIF").getImage(), // 9
			new ImageIcon("resources/GameImages/aaaa.jpg").getImage() };// 10
