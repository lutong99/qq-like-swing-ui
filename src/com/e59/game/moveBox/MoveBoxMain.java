...
public class MoveBoxMain extends JFrame {
	...
	public MoveBoxMain() {
		...
		// 窗口图片
		setIconImage(new ImageIcon("resources/GameImages/9.GIF").getImage());
		...
		ImageIcon z = new ImageIcon("resources/GameImages/aaaa1.jpg");
		JLabel jl = new JLabel(z);
		jl.setBounds(0, 0, 100, 600);// 添加背景图片
		dong.add(jl);

		ImageIcon x = new ImageIcon("resources/GameImages/aaaa.jpg");
