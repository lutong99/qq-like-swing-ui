...
//			
	...
	void addpan() {
		...
		try {
			 ...
			 * 初始化图片缓冲区
			 */
			cannon = ImageIO.read(new File("resources/Fishing/pao.png"));
			coin = ImageIO.read(new File("resources/Fishing/金币.png"));
			background = ImageIO.read(new File("resources/Fishing/bg.jpg"));
			timeimage = ImageIO.read(new File("resources/Fishing/时间.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		/*
