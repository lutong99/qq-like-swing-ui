...
public class QQMainFrame extends CenterFrame {
	...
	static {
		try {
			mainImage = ImageIO.read(new File("resources/MainImages/MainBackground2.png"));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	 ...
	 * 背景图片
	 */
	private File[] backgroundIamges = { new File("resources/MainImages/MainBackground2.png"),
			new File("resources/MainImages/MainBackground3.jpg"), new File("resources/MainImages/MainBackground4.jpg"),
			new File("resources/MainImages/MainBackground5.jpg"), new File("resources/MainImages/MainBackground6.jpg"),
			new File("resources/MainImages/MainBackground7.png") };
...
//		i2 = i1;
	...
	protected void addComponent() {
		...
		// 关闭
		closeJLabel = new JLabel(new ImageIcon("resources/MainImages/Mainyclose.png"));
		...
		// 最小化
		minimizeJLabel = new JLabel(new ImageIcon("resources/MainImages/MainyMin.png"));
		...
		// 我的状态
		myStateJLabel = new JLabel(new ImageIcon("resources/MainImages/s_online.png"));
		...
		// 游戏和皮肤 还有下面
		themeJLabel = new JLabel(new ImageIcon("resources/MainImages/theme.png"));
		...
		// 游戏
		qqGameJLabel = new JLabel(new ImageIcon("resources/MainImages/qqGame.png"));
		...
		// qq音乐
		qqMusicJLabel = new JLabel(new ImageIcon("resources/MainImages/qqMusic.png"));
		...
		// 微云
		qqCloudJLabel = new JLabel(new ImageIcon("resources/MainImages/qqCloud.png"));
		...
		// 列表
		findFriendJLabel = new JLabel(new ImageIcon("resources/MainImages/findFriend.png"));
		...
		// 主面板的下面
		mainBottom = new JLabel(new ImageIcon("resources/MainImages/qqBottom.png"));
		mainBottom.setBounds(0, 565, 280, 35);
		qqMainPanel.add(mainBottom);

		// QQ Logo
		logoJLabel = new JLabel(new ImageIcon("resources/MainImages/logo.png"));
	...
	private class RightUp extends MouseAdapter {
		...
		public void mouseEntered(MouseEvent e) {
			if (e.getSource() == closeJLabel) {
				closeJLabel.setIcon(new ImageIcon("resources/MainImages/mainClose.png"));
			} else if (e.getSource() == minimizeJLabel) {
				minimizeJLabel.setIcon(new ImageIcon("resources/MainImages/MainMin.png"));
			} else {
		...
		public void mouseExited(MouseEvent e) {
			if (e.getSource() == closeJLabel) {
				closeJLabel.setIcon(new ImageIcon("resources/MainImages/Mainyclose.png")); // 设置为原来的样子
			} else if (e.getSource() == minimizeJLabel) {
				minimizeJLabel.setIcon(new ImageIcon("resources/MainImages/MainyMin.png")); // 设置为原来的样子
			} else {
		...
		public void mouseClicked(MouseEvent e) {
			if (e.getSource() == closeJLabel) {
				...
				if (showOptionDialog == 0) {
					...
					QQMainFrame.this.setExtendedState(JFrame.ICONIFIED);
				}

			} else if (e.getSource() == minimizeJLabel) {
				QQMainFrame.this.setExtendedState(JFrame.ICONIFIED); // 最小化, 说实话我连源码写的注释翻译完成之后都不认识, 但是这个可以最小化, 还是很厉害的
				minimizeJLabel.setIcon(new ImageIcon("resources/MainImages/MainyMin.png")); // 设置为原来的样子
			} else {
				// TODO 写一点点弹框出来的东西
			}
