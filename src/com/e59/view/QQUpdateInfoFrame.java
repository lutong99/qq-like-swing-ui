...
import com.e59.controller.QQMainController;
...
public class QQUpdateInfoFrame extends CenterFrame {
	...
	protected void addComponent() {
		...
		ImageIcon[] profiles = { new ImageIcon(loginQq.getPhoto()),
				new ImageIcon("resources/RegisterImages/Profiles/0_online.png"),
	...
	private class RightUp extends MouseAdapter {
		...
		public void mouseClicked(MouseEvent e) {
			if (e.getSource() == close) {
				...
				QQUpdateInfoFrame.this.setExtendedState(JFrame.ICONIFIED); // 最小化, 说实话我连源码写的注释翻译完成之后都不认识,
			} else {
