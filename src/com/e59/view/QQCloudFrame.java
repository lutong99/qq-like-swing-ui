...
import com.e59.controller.QQCloudController;
...
public class QQCloudFrame extends CenterFrame {
	...
	static {
		try {
			titleImage = ImageIO.read(new File("resources/CloudImages/qqCloudTitle.png"));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public QQCloudFrame(QQ loginQQ) {
		...
		this.setIconImage(new ImageIcon("resources/CloudImages/cloud.png").getImage());
	}
...
//		upLoadJLabel=new JLabel(new ImageIcon("resources/CloudImages/upload.png"));
...
//		
		...
		// 我的资源的标签
		myResourcesJLabel = new JLabel(new ImageIcon("resources/CloudImages/myResources.png"));
		...
		propertiesJLabel = new JLabel(new ImageIcon("resources/CloudImages/properties.png"));
//		propertiesJLabel.setFont(new Font("宋体",Font.PLAIN,23));
		...
		// 下载的操作
		downloadJLabel = new JLabel(new ImageIcon("resources/CloudImages/download.png"));
		downloadJLabel.setCursor(cursor);// 手型
		downSectorJPanel.add(downloadJLabel);
		downloadJLabel.addMouseListener(mouseClick);

		// 删除的操作
		deleteJLabel = new JLabel(new ImageIcon("resources/CloudImages/delete.png"));
...
//								saveChooser.setSelectedFile(new File(name));
		...
		public void mouseEntered(MouseEvent e) {
			if (e.getSource() == closeJLabel) {
				closeJLabel.setIcon(new ImageIcon("resources/CloudImages/loginclose.png"));
			} else if (e.getSource() == minimizeJLabel) {
				minimizeJLabel.setIcon(new ImageIcon("resources/CloudImages/loginMin.png"));
			} else {
